	...
	public class SimpleEditor : System.Web.UI.WebControls.TextBox, interfaces.IDataEditor
	{
		...
		protected override void Render(HtmlTextWriter output)
		{
			...
			output.WriteLine(	"<p align=\"right\" style=\"margin: 0px; padding:0px\"><a href=\"javascript:insertLink(document.getElementById('" + this.ClientID + "'))\">" +
                "<img src=\"" + Umbraco.Core.IO.IOHelper.ResolveUrl(Umbraco.Core.IO.SystemDirectories.UmbracoClient) + "/simpleEditor/images/link.gif\" border=\"0\" align=\"right\" />" +
				"</a>" +
                "<a href=\"javascript:insertTag(document.getElementById('" + this.ClientID + "'), 'em', '')\">" +
                "<img src=\"" + Umbraco.Core.IO.IOHelper.ResolveUrl(Umbraco.Core.IO.SystemDirectories.UmbracoClient) + "/simpleEditor/images/italic.gif\" border=\"0\" style=\"margin-left: 3px; margin-right: 3px;\" align=\"right\" />" +
				"</a>" +
				" <a href=\"javascript:insertTag(document.getElementById('" + this.ClientID + "'), 'strong', '')\">" +
                "<img src=\"" + Umbraco.Core.IO.IOHelper.ResolveUrl(Umbraco.Core.IO.SystemDirectories.UmbracoClient) + "/simpleEditor/images/bold.gif\" border=\"0\" align=\"right\" />" +
				"</a>" +
				"<br/></p>");
			base.Render(output);
