...
namespace umbraco.presentation.install.steps.Definitions
{
    ...
    public class Welcome : InstallerStep
    {
        ...
        {
            get { return Umbraco.Core.IO.SystemDirectories.Install + "/steps/welcome.ascx"; }
        }
    ...
    public class WebPi : InstallerStep
    {
        ...
        public override string UserControl
        {
            get { return Umbraco.Core.IO.SystemDirectories.Install + "/steps/skinning.ascx"; }
        }
    ...
    public class TheEnd : InstallerStep
    {
        ...
        public override string UserControl
        {
            get { return Umbraco.Core.IO.SystemDirectories.Install + "/steps/theend.ascx"; }
        }
    ...
    public class License : InstallerStep
    {
        ...
        public override string UserControl
        {
            get { return Umbraco.Core.IO.SystemDirectories.Install + "/steps/license.ascx"; }
        }
    ...
    public class DefaultUser : InstallerStep
    {
        ...
        public override string UserControl
        {
            get { return Umbraco.Core.IO.SystemDirectories.Install + "/steps/defaultuser.ascx"; }
        }
